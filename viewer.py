...
class LaserAreaViewer:
    def __init__(self, root: tk.Tk):
        ...
        self.entry_start_angle.bind("<Return>", self.on_angle_change)
        self.entry_start_angle.bind("<FocusOut>", self.on_angle_change)
        self.entry_start_angle.bind("<KeyRelease>", self.on_angle_change)
    ...
    def on_angle_change(self, event=None) -> None:
        try:
            angle = float(self.entry_start_angle.get())
        except ValueError:
            return
